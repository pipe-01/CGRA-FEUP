...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.textureWT = new CGFtexture(this, "textures/waterTex.jpg");
		this.textureWM = new CGFtexture(this, "textures/waterMap.jpg");
		if(this.waterDisplay){
		this.appearance.setTexture(this.textureWT);
		this.appearance.setTextureWrap('REPEAT', 'REPEAT');
		}
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/ex3.vert", "shaders/ex3.frag"),
