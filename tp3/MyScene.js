...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        // this.ambientLighty = 0.3;
        // this.ambientLightz = 0.3;
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(84/255, 71/255, 62/255, 1.0); //139,90,43
        this.material4.setDiffuse(139/255, 99/255, 43/255, 1.0);
